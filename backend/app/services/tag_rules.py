...
def _is_redundant_topic_for_category(topic_key: str, category_path: str) -> bool:
    ...
    if path.startswith("finance/bills/electricity") and value in {
        "electricity",
        "electricity-bill",
        "invoice",
        "bill",
        ...
        return True
    if path.startswith("finance/bills/water") and value in {
        "water",
        "water-bill",
        "invoice",
        "bill",
        ...
        return True
    if path.startswith("finance/bills/gas") and value in {
        "gas",
        "gas-bill",
        "invoice",
        "bill",
        ...
        return True
    if path.startswith("finance/bills/internet") and value in {
        "internet",
        "internet-bill",
        "invoice",
        "bill",
